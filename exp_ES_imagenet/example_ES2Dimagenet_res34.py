# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6  python -m torch.distributed.launch --nproc_per_node=7 example_ES2Dimagenet_res34.py
...
master = False 
save_folder = 'ESimagenet_CNN_res34_gray'
...
train_dataset = ESImagenet2D_Dataset(mode='train',data_set_path='/data/ES-imagenet-0.18/')
