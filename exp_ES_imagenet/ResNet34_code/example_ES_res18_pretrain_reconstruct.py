...
# 使用以下命令直接执行
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 python -m torch.distributed.launch --nproc_per_node=7  example_ES_res18_pretrain_reconstruct.py
...
master = False 
save_folder = 'LIAF_from_ANN_and_warmup_reconstruct'
...
checkpoint = torch.load('./LIAF_warmup_on_imagenet_18_reconstruct/pre_warmup_0.pkl', map_location=torch.device('cpu'))
