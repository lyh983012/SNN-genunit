# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6  python -m torch.distributed.launch --nproc_per_node=7 example_Imagenet_res18_pretrain.py
...
master = False 
save_folder = 'ResNet18_imagenet_LIF_pretrain'
#save_folder = 'ResNet18_imagenet_CNN_spike_pretrain'
...
checkpoint = torch.load('./ResNet18_imagenet_LIAF_pretrain/sgd_65.pkl', map_location=torch.device('cpu'))
        ...
        if master:
            ...
            if acc > bestacc:
                ...
                torch.save(snn.module.state_dict(),
                         './'+save_folder+'/sgd_'+str(int(bestacc))+'.pkl')
