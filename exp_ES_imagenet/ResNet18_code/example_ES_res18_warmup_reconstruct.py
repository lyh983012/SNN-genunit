...
# 使用以下命令直接执行
# CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 example_ES_res18_warmup_reconstruct.py
...
master = False 
save_folder = 'LIAF_warmup_on_imagenet_18_reconstruct'
...
snn.load_state_dict(torch.load('./ES2Dimagenet_res18_pure/43.pkl'))
...
for epoch in range(pre_epochs):
    ...
    torch.save(snn.module.state_dict(),
           './'+save_folder+'/pre_warmup_'+str(int(bestacc))+'.pkl')
