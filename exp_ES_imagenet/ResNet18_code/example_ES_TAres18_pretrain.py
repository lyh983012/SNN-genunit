...
# 使用以下命令直接执行
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 python -m torch.distributed.launch --nproc_per_node=7 example_ES_TAres18_pretrain.py
...
master = False 
save_folder = 'LIAF_18_TA_pretrained(warmuped)'
...
model_dict = snn.state_dict()
pretrained_dict = {k: v for k, v in checkpoint.items() if k in model_dict}
model_dict.update(pretrained_dict)
snn.load_state_dict(model_dict)
