...
# 使用以下命令直接执行
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 python -m torch.distributed.launch --nproc_per_node=7 example_ES_VGG16.py
...
import LIAF
import TA
from LIAFnet.LIAFVGG16 import *

modules = import_module('LIAFnet.LIAFVGG16')
