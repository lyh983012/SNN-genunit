...
save_folder = 'mnist_scnn_pre_lif_from_ann'
writer = SummaryWriter(comment='../runs/mnist_scnn_pre_lif_from_ann')
...
snn.load_state_dict(torch.load('/home/lyh/pre_train/exp_N_MNIST/MNIST_pretrain/99modelsaved.t7'))
snn.to(device)
