...
snn.load_state_dict(torch.load(workpath+'/MNIST_pretrain/99modelsaved.t7'))
snn.to(device)
...
for epoch in range(num_epochs):
   ...
   #evaluation
    ...
    if acc > best_acc:
        ...
        print('===> Saving models...')
        torch.save(snn.state_dict(), workpath+'/'+save_folder+'/'+str(int(best_acc))+'LIAF_fromann_modelsaved.t7')
        print('===> Saved')
        print("best:",best_acc)
